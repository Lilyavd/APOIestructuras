...
public class PanelCancion extends JPanel implements ActionListener
{
    ...
    public PanelCancion( InterfazKaraoke pVentana )
    {
        ...
        btnPausar = new JButton( new ImageIcon( BarraOpciones.RUTA_ICONOS + "pausar.png" ) );
        btnPausar.setActionCommand( PAUSAR );
        btnPausar.addActionListener( this );
        botones.add( btnPausar );

        btnReproducir = new JButton( new ImageIcon( BarraOpciones.RUTA_ICONOS + "reproducir.png" ) );
        btnReproducir.setActionCommand( REPRODUCIR );
        btnReproducir.addActionListener( this );
        botones.add( btnReproducir );

        btnParar = new JButton( new ImageIcon( BarraOpciones.RUTA_ICONOS + "detener.png" ) );
    ...
    public void actualizar( Cancion pCancion )
    {
        if( pCancion != null )
        {
            ...
            principal.actualizarEliminarCancion(true);
        ...
        else
        {
            ...
            txtNombre.setText( "" );
            ruta = null;
            principal.actualizarEliminarCancion(false);
