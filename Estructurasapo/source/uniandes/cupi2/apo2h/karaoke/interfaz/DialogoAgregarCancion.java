...
public class DialogoAgregarCancion extends JDialog implements ActionListener
{
	 ...
	 */
	private JComboBox<Artista> comboArtistas;
	...
	public void actionPerformed(ActionEvent pEvento)
	{
		...
		{
			Artista artista = (Artista) comboArtistas.getSelectedItem();
					...
					letra != null && !letra.isEmpty() && artista != null)
			{
				try
				{
					...
					if(duracion > 0)
					{
						...
						{
							principal.agregarCancion(artista, new Cancion(nombre, duracion, letra, dificultad, ruta));
							this.dispose();
						}
						else
						{
		...
		else if(comando.equals(CAMBIO_CATEGORIA))
    	{
    		...
    		List<Artista> artistas = principal.darArtistasCategoria( categoria );
